...
import com.iterminal.ndis.model.Title;
...
public class SqlCustomQueryRepository {
    ...
    public List<Title> getTitleList() {
        String sql = "select * from title order by id";
        Query query = entityManager.createNativeQuery(sql, Title.class);
        List<Title> resultList = query.getResultList();
        return resultList;
    }
